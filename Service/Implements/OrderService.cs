...
namespace Services.Implements
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<dynamic> RequireAnExchangeOrderAsync(CreateExOrderDTO orderDTO, string customerEmail)
        {
        ...
        public async Task<dynamic> AcceptRequiredExchangeOrderAsync(string orderId, string customerEmail)
        {
        ...
        public async Task<dynamic> RefuseRequiredExchangeOrderAsync(string orderId, string customerEmail)
        {
            var customer = await _accountRepository.GetAccountByEmailAsync(customerEmail);
            if (customer == null)
            {
        ...
        public async Task<dynamic> CreateAnOrderForExchangeAsync(string orderId, string customerEmail)
        {
            var customer = await _accountRepository.GetAccountByEmailAsync(customerEmail);
            if (customer == null)
            {
        ...
        public async Task<dynamic> CreateAnOrderBuyFromCartAsync(CreateAnBuyOrderDTO orderDTO, string customerEmail)
        {
            var customer = await _accountRepository.GetAccountByEmailAsync(customerEmail);
            if (customer == null)
            {
...
,
        ...
        public async Task<dynamic> GetNumberOrderOfCustomerByStatus(int status, string customerEmail)
        {
            var customer = await _accountRepository.GetAccountByEmailAsync(customerEmail);
            if (customer == null)
            {
        ...
        public async Task<dynamic> GetNumberOrderOfCustomer(string customerEmail)
        {
            var customer = await _accountRepository.GetAccountByEmailAsync(customerEmail);
            if (customer == null)
            {
        ...
        public async Task<double> GetTotalEarnings(string customerEmail)
        {
            var customer = await _accountRepository.GetAccountByEmailAsync(customerEmail);
            if (customer == null)
            {
