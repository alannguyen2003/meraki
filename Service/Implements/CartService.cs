...
namespace Services.Implements
{
    public class CartService : ICartService
    {
        ...
        public async Task<dynamic> AddToCartAsync(AddToCartDTO cartDTO, string customerEmail)
        {
        ...
        public async Task<dynamic> UpdateCartItemAsync(string cartItemId, double? quantity, string customerEmail)
        {
            var customer = await _accountRepository.GetAccountByEmailAsync(customerEmail);
            if (customer == null)
            {
        ...
        public async Task<dynamic> DeleteCartItemAsync(string cartItemId, string customerEmail)
        {
            var customer = await _accountRepository.GetAccountByEmailAsync(customerEmail);
            if (customer == null)
            {
        ...
        public async Task<dynamic> GetCartListAsync(string customerEmail)
        {
            var customer = await _accountRepository.GetAccountByEmailAsync(customerEmail);
            if (customer == null)
            {
